...
<html lang="fr">
    ...
    <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#chapters">Chapitres</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../blog_ecrivain/index.php?action=loginMember">Connexion</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <!-- Page Header -->
      <header class="masthead" style="background-image: url('view/public/img/alaska-winter.jpg')">
          ...
          <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
              <div class="site-heading">
                ...
                <span class="subheading">Une histoire vrai d'un voyage hors norme</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
              ...
              <p class="copyright text-muted">Copyright&copy; JeanForteroche - Billet pour l'Alaska 2018</p>
            </div>
          </div>
        </div>
      </footer>
